...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($dbcon, $sql) or die("发布失败" . mysqli_connect_error());

    $permalink = "p/".mysqli_insert_id($dbcon) ."/".$slug;

    printf("发布成功. <meta http-equiv='refresh' content='2; url=%s'/>",
       $permalink);
    ...
    <div class="w3-container">
        <div class="w3-card-4">
            ...
            <form class="w3-container" method="POST">
                ...
                <p>
                    <input type="submit" class="w3-btn w3-teal w3-round" name="submit" value="发布">
                </p>
            </form>
