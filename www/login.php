...
echo '<h2 class="w3-container w3-teal">登录界面</h2>';
...
if (isset($_POST['log'])) {
    ...
    if ($row_count == 1 && password_verify($password, $row['password'])) {
        ...
        echo "<div class='w3-panel w3-pale-red w3-display-container'>用户名或密码错误.</div>";
    }
}
    ?>
    ...
    <form action="" method="POST" class="w3-container w3-padding">
        ...
        <p><input type="submit" name="log" value="登录" class="w3-btn w3-teal"></p>
    </form>
