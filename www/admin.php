...
?>
    <h2 class="w3-container w3-teal w3-center">管理界面</h2>
    <div class="w3-container">
        <p>欢迎！ <?php echo $_SESSION['username']; ?>,</p>
        <p><a href="new.php" class="w3-button w3-teal">新建帖子</a></p>

    </div>
    <h5 class="w3-center">帖子</h5>
<?php
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <tr>
        ...
        <td><?php echo $time; ?></td>
        <td><a href="edit.php?id=<?php echo $id; ?>">编辑</a> | <a href="del.php?id=<?php echo $id; ?>"
