...
if (isset($_POST['upd'])) {
    ...
    if (mysqli_query($dbcon, $sql2)) {
        ...
        echo "编辑失败" . mysqli_connect_error();
    }
}
?>
    ...
    <div class="w3-card-4">
        ...
        <div class="w3-container w3-teal">
            ...
            <h4 class="w3-container"><a href="<?=$permalink?>">跳转到该帖</a> </h4>
        ...
        <form action="" method="POST" class="w3-container">
            ...
            <p>
                <input type="submit" class="w3-btn w3-teal w3-round" name="upd" value="保存修改">
            </p>

            <p>
            <div class="w3-text-red">
                <a href="<?=$url_path?>del.php?id=<?php echo $row['id']; ?>"
                   onclick="return confirm('你确定要·删除该贴吗?'); ">删除该贴</a></div>
            </p>
        </form>
    </div>
    </div>
